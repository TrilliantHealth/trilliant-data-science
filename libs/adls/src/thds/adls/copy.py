...
from thds.core import log, thunks
...
CopyProperties = ty.Dict[str, ty.Union[str, datetime.datetime]]
...
def _copy_file(
    ...
    *,
    ...
    sas_token = gen_blob_sas_token(
        src,
        account_key=get_account_key(get_global_blob_service_client(src.sa)),
...
def copy_file(
    ...
    *,
    ...
    func = thunks.thunking(_copy_file)(
        src_fqn, dest_fqn, overwrite_method=overwrite_method, get_account_key=get_account_key
    )
