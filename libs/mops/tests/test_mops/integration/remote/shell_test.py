"""This tests the majority of thds.mops.remote without needing a Kubernetes cluster."""
import logging
import typing as ty
...
from thds.mops.remote import AdlsPickleRunner, Shell, ShellBuilder, pure_remote, set_pipeline_id, tempdir
...
def test_shell_builder(caplog):
    ...
    a2 = pure_remote(AdlsPickleRunner(ShellBuilder(build_shell)))(add2)  # type: ignore
