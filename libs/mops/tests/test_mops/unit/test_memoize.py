...
from thds.mops.remote import pipeline_id_mask, pipeline_id_mask_from_docstr
from thds.mops.remote._memoize import make_function_memospace
from thds.mops.remote.memoize import extract_mask_from_docstr, get_pipeline_id_mask
...
FX_NAME = "tests.test_mops.unit.test_memoize:fx"
