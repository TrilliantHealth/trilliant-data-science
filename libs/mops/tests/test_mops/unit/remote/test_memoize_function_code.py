...
from thds.mops.remote._memoize_function_code import make_unique_name_including_docstring_key
...
MODULE_BASE = "tests.test_mops.unit.remote.test_memoize_function_code"
