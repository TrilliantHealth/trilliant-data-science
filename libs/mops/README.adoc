...
* link:docs/tools.adoc[CLI tools] for inspecting and summarizing mops invocations
* link:docs/debugging.adoc[Debugging guide] - storage structure, metadata files, run IDs, and diagnosing race conditions
